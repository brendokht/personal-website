...
import championsGgHomeImg from "../images/champions-gg-home.png";
...
<div class="my-8 flex flex-wrap gap-8">
  ...
  <ProjectContainer
    title="Champions GG"
    description="A personal project for Esports event management. Users can create
        teams, host leagues, tournaments and other events for multiple game
        titles."
    reference="champions-gg/"
    imageSrc={championsGgHomeImg}
    imageAlt="Home page of Champions GG website"
    eager={true}
  />
  <ProjectContainer
