...
<a
  href="#about"
  class="mt-20 flex justify-center transition-transform duration-200 hover:scale-90 hover:cursor-pointer"
>
  <ArrowDown />
</a>
...
<div class="my-8 flex flex-wrap justify-center gap-8 md:justify-start">
  <ProjectContainer
    title="Ascnd GG"
  ...
  <ProjectContainer
    ...
    reference="/projects/chat-system/"
